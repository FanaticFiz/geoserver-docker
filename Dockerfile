...
COPY resources/geoserver-2.28-SNAPSHOT-jdbcstore-plugin/* /usr/local/tomcat/webapps/geoserver/WEB-INF/lib/
COPY resources/geoserver-2.28-SNAPSHOT-sec-oauth2-google-plugin/* /usr/local/tomcat/webapps/geoserver/WEB-INF/lib/

COPY resources/jjwt-0.9.1.jar /usr/local/tomcat/webapps/geoserver/WEB-INF/lib/
COPY resources/gs-sec-oauth2-google-2.28.0.jar /usr/local/tomcat/webapps/geoserver/WEB-INF/lib/
